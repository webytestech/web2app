...
class Config {
  ...
  /// Generated by SiteNative 22-09-2022 18:20:09
  /// App UID: 231a0cc1-fa58-04da-4faf-40a340f132dd
  /// Version: https://web2app.tech/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "Webmaster";
  // App link
  static String appLink = "https://webmastertools.live";
  ...
  /// *** Drawer settings *** ///
  // Title
  static String drawerTitle = "Webmaster";
  // Subtitle
  static String drawerSubtitle = "Tools";
  // Background mode
  ...
  // Signing
  static String osSigning = "7d0c61d8502de023fca8e48850aed92fb68a96cc179cad59d654cf30b62f45e6";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "Main",icon: "albums-outline.svg",type: ActionType.internal,value: "https://webmastertools.live",),
